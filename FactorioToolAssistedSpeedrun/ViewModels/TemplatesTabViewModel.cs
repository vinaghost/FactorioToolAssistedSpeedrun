...
namespace FactorioToolAssistedSpeedrun.ViewModels
{
    public partial class TemplatesTabViewModel : ObservableObject
    {
        ...
        public TemplatesTabViewModel(StepTypePanelViewModel stepTypePanelViewModel, StepDetailPanelViewModel stepDetailPanelViewModel, CommandStack commandStack)
        {
